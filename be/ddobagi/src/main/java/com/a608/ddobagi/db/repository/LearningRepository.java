...
public interface LearningRepository extends JpaRepository<Script, Long> {
	...
	public List<SituationContentByCategoryQueryDto> getSituationListByCategory(@Param("userId") Long userId1,
		@Param("userId") Long userId2, @Param("categoryCommon") String categoryCommon);
}
